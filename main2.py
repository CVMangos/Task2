...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def load_ui_elements(self):
        ...
        self.reset_buttons = [self.ui.resetButton, self.ui.resetContour]
...
###################################################################################
    ...
    def reset_image(self, event, index: int):
        ...
        self.reset_activeContour()


    def reset_activeContour(self):
        for i in range(0,2):
            self.input_ports[i].clear_points()
            self.out_ports[i].clear_points()
        # self.input_ports[1].clear_points()
        # self.out_ports[1].clear_points()
